export const ES = {
   ...
   AbuSimbelDesc: "Dobla el efecto de Ramsés II. Todas las maravillas adyacentes obtienen +1 de felicidad",
   ...
   AccountUpgradeConfirmDescV2:
      "Mejorar tu cuenta <b>reiniciará tu partida actual</b> y trasladará los personajes históricos permanentes hasta los niveles permitidos. Esto <b>no puede</b> ser deshecho, ¿quieres continuar?",
   Acropolis: "Acrópolis",
   ...
   BattleshipBuilder: "Constructor de acorazados",
   Biplane: "Biplano",
   ...
   BuildingDefaultsCount: "%{count} propiedades son anuladas en la construcción predeterminada",
   BuildingDefaultsRemove: "Eliminar todas las propiedades anuladas",
   BuildingMultipliers: "Aumento",
   BuildingName: "Nombre",
   BuildingNoMultiplier:
      "%{building} <b>no está afectada</b> por ningún multiplicador (producción, capacidad de trabajo, almacenamiento, etc)",
   ...
   ChoghaZanbil: "Choga Zanbil",
   ChoghaZanbilDesc: "Choga Zanbil",
   ...
   ElectrificationPowerRequired: "Energía necesaria",
   ...
   Embassy: "Embajada",
   EmpireValueFromBuildings: "Por construcciones",
   EmpireValueFromResources: "Por recursos",
   ...
   ExploreThisTileHTML:
      "Un explorador explorará <b>esta casilla y las adyacentes</b>. Los exploradores se generan en la %{name}. Te quedan %{count} exploradores",
   ...
   FontSizeScaleDescHTML:
      "Cambia la escala del tamaño de la interfaz. <b>Establecer una escala mayor de 1x puede romper algunos elementos de la interfaz</b>",
   ...
   GalileoGalileiDesc: "+%{value} de ciencia por trabajadores en paro",
   Galleon: "Galeón",
   ...
   GrandBazaarTabActive: "Activos",
   GrandBazaarTabTrades: "Comercios",
   GraphicsDriver: "Gráficos: %{driver}",
   ...
   GreatSphinxDesc:
      "Todas las construcciones de rango II o mayor a una distancia de hasta 2 casillas obtienen +N multiplicadores de consumo y producción. N = Número de construcciones adyacentes del mismo tipo",
   ...
   ManhattanProjectDesc: "Proyecto Manhattan",
   Marble: "Mármol",
   ...
   MountSinaiDesc:
      "Cuando se descubre, nace un nuevo personaje histórico de la era actual. Todas las construcciones que producen fé obtienen +5 multiplicadores de almacenamiento",
   Movie: "Película",
   ...
   Newspaper: "Periódico",
   NextExplorersIn: "Proximos exploradores en",
   NextMarketUpdateIn: "Próxima actualización del mercado en",
   NileRiver: "Río Nilo",
   NileRiverDesc:
      "Dobla el efecto de Hatshepsut. Todos los cultivos de trigo obtienen +1 multiplicador de producción y almacenamiento. Todos los cultivos de trigo adyacentes obtienen +5 multiplicadores de producción y almacenamiento",
   NoDepositDesc:
   ...
   NuclearFuelRod: "Barra de cumbustible nuclear",
   ...
   Parthenon: "Partenón",
   ParthenonDescV2:
      "Nacen dos personajes históricos de la edad antigua y obtienes 4 elecciones para cada uno. El gremio de músicos y el gremio de pintores obtienen +1 multiplicador de producción, capacidad de trabajo y almacenamiento, y están extentos del -1 de felicidad",
   ...
   PermanentGreatPeopleLevels: "Niveles de personajes históricos permanentes",
   ...
   PetraOfflineTimeReconciliation:
      "Has recibido %{count} saltos temporales por el tiempo que ha estado el servidor offline",
   Petrol: "Gasolina",
   ...
   PlayerTradeClaimAllFailedMessageV2: "No se han podido reclamar ningún comercio. ¿El almacén está lleno?",
   ...
   PlayerTradeFiltersClear: "Borrar",
   PlayerTradeFrom: "De",
   ...
   ProductionPriorityDescV2:
      "Una prioridad mayor quiere decir que esta construcción transporta recursos antes a otras construcciones. Números más grandes quieren decir una mayor prioridad",
   Progress: "Progreso",
   ...
   ReadFullPatchNotes: "Leer notas del parche",
   Reborn: "Renacer",
   ...
   RequiredWorkersTooltip:
      "El número de trabajadores necesarios para la producción es igual a la suma de todos los recursos consumidos y producidos después de aplicar los multiplicadores (excepto la electrificación)",
